...
import com.webburguer.burguer3j.repository.OrdenRepository;
...
public class OrdenServiceImpl implements OrdenService {
	...
	@Autowired
	OrdenRepository oerepository;
	
	@Override
	public Orden createOrden(Orden orden) {
		return oerepository.save(orden);
	}
	...
	public List<Orden> findByUsuario(User usuario) {
		return oerepository.findByUsuario(usuario);
	}

	@Override
	public Optional<Orden> findById(Long id) {
		return oerepository.findById(id);
	}
